...
class ClasseRobo():
	...
	def __init__(self, motor_direito, motor_esquerdo, motor_garra, sensor_direito, sensor_esquerdo, sensor_ultrasonico, distancia_centro, raio_roda, distancia_rodas):
